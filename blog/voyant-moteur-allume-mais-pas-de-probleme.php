...
<figure>
    <img src="/Image/voyant-moteur-allume-mais-pas-de-probleme-2.webp"
         alt="Calculateur moteur en mode de compensation — voyant orange fixe sans symptôme apparent"
         loading="lazy" decoding="async" width="1200" height="675">
    <figcaption>Le calculateur corrige les paramètres d'injection en temps réel pour masquer la panne au conducteur.</figcaption>
</figure>
...
<figure>
    <img src="/Image/voyant-moteur-allume-mais-pas-de-probleme-3.webp"
         alt="Boîtier OBD2 branché sur la prise diagnostic — lecture du code défaut voyant moteur"
         loading="lazy" decoding="async" width="1200" height="675">
    <figcaption>La prise OBD2 se trouve généralement sous la colonne de direction, côté conducteur.</figcaption>
</figure>
