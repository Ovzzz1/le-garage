...
$article = ['title' => 'Alvis : Le Joyau Discret de Coventry (Guide Complet)', 'subtitle' => 'Première traction avant au monde en production, moteurs aluminium précurseurs : Alvis était à l\'avant-garde. Pourquoi cette marque géniale a-t-elle disparu ?', 'category' => 'occasion', 'category_name' => 'Achat & Occasion', 'category_color' => '#7c3aed', 'tags' => ['Alvis', 'Coventry', 'Britannique', 'Collection'], 'image' => '', 'date' => '24 Mars 2026', 'author' => 'Arnaud', 'author_role' => 'Historien Auto', 'author_img' => '/Image/arnaud.png', 'author_bio' => 'Arnaud a un faible pour les constructeurs de Coventry qui ont marqué l\'histoire sans la reconnaissance qu\'ils méritaient.', 'reading_time' => '5 min'];
