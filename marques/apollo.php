...
$article = ['title' => 'Apollo Automobil : L\'Hypercar Allemande que Peu Connaissent', 'subtitle' => 'Née des cendres de Gumpert, Apollo Automobil crée des hypercars V12 atmosphériques d\'une brutalité rare. Découverte d\'un constructeur hors norme.', 'category' => 'occasion', 'category_name' => 'Achat & Occasion', 'category_color' => '#7c3aed', 'tags' => ['Apollo', 'Hypercar', 'Allemagne', 'V12'], 'image' => '/Image/marques/apollo-hero.webp', 'date' => '24 Mars 2026', 'author' => 'Arnaud', 'author_role' => 'Expert Supercars', 'author_img' => '/Image/arnaud.png', 'author_bio' => 'Arnaud traque les constructeurs d\'hypercars ultra-confidentiels et considère l\'IE comme l\'une des créations les plus pures de ce siècle.', 'reading_time' => '5 min'];
...
?>
<article>
    <section class="art-hero"><img src="<?php echo $article['image']; ?>" alt="Apollo Intensa Emozione noire sur circuit" class="art-hero-bg"><div class="art-hero-overlay"></div><div class="art-hero-container"><div class="art-hero-content">
...
<script type="application/ld+json">{"@context":"https://schema.org","@type":"Article","mainEntityOfPage":{"@type":"WebPage","@id":"https://www.garageraymond.fr/marques/apollo"},"headline":"<?php echo addslashes($article['title']); ?>","description":"<?php echo addslashes($page_description); ?>","datePublished":"2026-03-24T08:00:00+01:00","author":{"@type":"Person","name":"<?php echo $article['author']; ?>"},"publisher":{"@type":"Organization","name":"Le garage expert Auto","url":"https://www.garageraymond.fr"}}</script>
