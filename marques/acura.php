...
$article = ['title' => 'Acura : Quand Honda Joue dans la Cour des Grands', 'subtitle' => 'Première marque japonaise de luxe, Acura ouvre la voie dès 1986 en Amérique du Nord. NSX, Integra Type R, MDX : les modèles qui ont défié Lexus et Infiniti.', 'category' => 'occasion', 'category_name' => 'Achat & Occasion', 'category_color' => '#7c3aed', 'tags' => ['Acura', 'Honda', 'NSX', 'Japon', 'Premium'], 'image' => '', 'date' => '24 Mars 2026', 'author' => 'Arnaud', 'author_role' => 'Expert Auto', 'author_img' => '/Image/arnaud.png', 'author_bio' => 'Arnaud vénère la fiabilité légendaire des moteurs Honda et considère la NSX originale comme la supercar la plus sous-estimée de l\'histoire.', 'reading_time' => '7 min'];
