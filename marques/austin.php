...
$article = ['title' => 'Austin : Le Constructeur qui a Motorisé la Grande-Bretagne', 'subtitle' => 'Herbert Austin a mis l\'Angleterre sur roues avec l\'Austin Seven en 1922, puis l\'a réinventée avec la Mini en 1959. L\'histoire du plus grand constructeur britannique jamais créé.', 'category' => 'occasion', 'category_name' => 'Achat & Occasion', 'category_color' => '#7c3aed', 'tags' => ['Austin', 'Mini', 'Seven', 'Britannique'], 'image' => '', 'date' => '24 Mars 2026', 'author' => 'Arnaud', 'author_role' => 'Historien Auto', 'author_img' => '/Image/arnaud.png', 'author_bio' => 'Arnaud voit en Austin le Ford britannique : un géant populaire qui a démocratisé l\'automobile sur une île entière.', 'reading_time' => '7 min'];
...
?>
<article>
    <section class="art-hero"><img src="<?php echo $article['image']; ?>" alt="Austin Seven classique" class="art-hero-bg" onerror="this.setAttribute('data-error','true')" onerror="this.setAttribute('data-error','true')"><div class="art-hero-overlay"></div><div class="art-hero-container"><div class="art-hero-content">
