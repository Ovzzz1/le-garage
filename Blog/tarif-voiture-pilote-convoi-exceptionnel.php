...
$article = [
    ...
    'tags'           => ['#ConvoiExceptionnel', '#VoiturePilote', '#TarifTransport', '#APRR'],
    ...
    <div class="art-layout-wrapper">
        ...
        <div class="art-main-col">
            ...
            <div class="art-content">
                ...
                </div><h2 id="exemples">Exemples de budgets selon le type de mission</h2>
...
<style>
/* ─── Aération Textes & Listes ─── */
.art-tldr ul, .art-content ul {
    display: flex;
...
.calc-detail-block ul { padding-left: 18px; margin: 0; }
